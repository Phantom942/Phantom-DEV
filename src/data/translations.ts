export const translations = {
  fr: {
    ...
    sections: {
      ...
      contact: "Contact",
      contactDesc: "Un projet en tête ? Contactez-moi sur WhatsApp pour un devis gratuit sous 24h, sans engagement.",
      performance: "Garantie performance : Lighthouse 90+ sur tous les sites livrés. Site vitrine livrable en 48h.",
      or: "ou",
      response: "Réponse sous 24h · Site livrable en 48h · Sans engagement",
      projectsSectionAria:
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Comment contacter PhantomDev pour un devis ?", a: "Contactez PhantomDev via WhatsApp pour un devis gratuit sous 24h, sans engagement. Le site phantomdev.fr propose un accès direct à la ligne WhatsApp depuis la page d’accueil et la page Contact." },
    ...
    contactForm: {
      ...
      urgency: "Besoin pour quand ?",
      urgencyOptions: {
        empty: "Délai souhaité",
      ...
      response24h: "Réponse sous 24h, sans engagement",
      emailRequired: "Email requis pour recevoir une réponse",
      submitSuccess: "Message envoyé ! Je vous recontacte sous 24h.",
    ...
    servicesPage: {
      ...
      pageTitle: "Services",
      introLead:
        "Chaque ligne ci-dessous répond à une intention business : être crédible, vendre en ligne, gagner en visibilité (SEO), industrialiser un outil, ou intégrer l’IA sans bricolage. Chaque projet fait l’objet d’un devis adapté au périmètre — toujours clair, sous 24h.",
      introSub:
        "Réponse sous 24h · Sans engagement · France, Europe & international · Lighthouse 90+ sur les sites livrés",
      trustPoints: [
      ...
      cardReassurance: "Sans engagement · Réponse sous 24h",
    },
    stats: {
  ...
  "en-GB": {
    ...
    sections: {
      ...
      contact: "Contact",
      contactDesc: "Got a project in mind? Contact me on WhatsApp for a free quote within 24h, no commitment.",
      performance: "Performance guarantee: Lighthouse 90+ on all delivered sites. Landing page deliverable in 48h.",
      or: "or",
      response: "Response within 24h · Site deliverable in 48h · No commitment",
      projectsSectionAria:
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How to contact PhantomDev for a quote?", a: "Contact PhantomDev via WhatsApp for a free quote within 24h, no commitment. The phantomdev.fr site offers direct access to WhatsApp from the homepage and Contact page." },
    ...
    contactForm: {
      ...
      response24h: "Response within 24h, no commitment",
      emailRequired: "Email required to receive a reply",
      submitSuccess: "Message sent! I'll get back to you within 24h.",
    ...
    servicesPage: {
      ...
      pageTitle: "Services",
      introLead:
        "Each offer maps to a business goal: build trust, sell online, grow organic visibility (SEO), ship a serious product, or integrate AI without duct tape. Every project gets a quote tailored to scope — always clear within 24h.",
      introSub:
        "Reply within 24h · No commitment · France, Europe & worldwide · Lighthouse 90+ on delivered sites",
      trustPoints: [
        "Lighthouse 90+ guarantee",
        "Simple sites: fast go-live possible",
        "Detailed quote within 24h",
      ...
      cardReassurance: "No commitment · Reply within 24h",
    },
    stats: {
