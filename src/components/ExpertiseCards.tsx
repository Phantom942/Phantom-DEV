            ...
            >
              ...
              <div className="relative">
                <Icon
                  ...
                  strokeWidth={1.25}
                />
                <h3 className="text-xs font-light tracking-[0.06em] text-[#f5f5f0] transition-colors duration-300 group-hover:text-[#f5f5f0] sm:text-sm md:text-base md:tracking-[0.08em]">
                  {card.title}
                </h3>
              </div>
            </motion.article>
